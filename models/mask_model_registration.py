...
from .mask_layers import MaskTransformerEncoder, MaskTransformerDecoder


@register_model('mask_transformer')
class MaskTransformer(FairseqModel):
...
#         base_architecture(args)
        ...
        decoder = MaskTransformerDecoder(args, tgt_dict, decoder_embed_tokens)
        
        return MaskTransformer(encoder, decoder)
