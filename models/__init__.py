...
#         base_architecture(args)
        ...
        def build_embedding(dictionary, embed_dim, path=None, add_mask=False):
            if add_mask:
                dictionary.add_symbol("<<MASK>>", n=1)
        ...
        tgt_embed_tokens = build_embedding(
            tgt_dict, args.decoder_embed_dim, args.decoder_embed_path, add_mask=True
        )
