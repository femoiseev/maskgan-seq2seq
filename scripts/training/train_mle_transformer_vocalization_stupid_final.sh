#!/usr/bin/env bash
mkdir -p ../../checkpoints/mle_transformer_vocalization_stupid_final
CUDA_VISIBLE_DEVICES=0 fairseq-train ../../data/processed/vocalization \
  ...
  --adam-betas '(0.9, 0.98)' --save-dir ../../checkpoints/mle_transformer_vocalization_stupid_final \
  --keep-last-epochs 100 --max-epoch 100