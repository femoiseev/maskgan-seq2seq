#!/usr/bin/env bash
mkdir -p ../../checkpoints/mle_transformer_vocalization_stupid1
CUDA_VISIBLE_DEVICES=0 fairseq-train ../../data/processed/vocalization \
  ...
  --adam-betas '(0.9, 0.98)' --save-dir ../../checkpoints/mle_transformer_vocalization_stupid1 \
  --keep-last-epochs 100 --max-epoch 200